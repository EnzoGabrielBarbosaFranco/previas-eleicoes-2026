(function () {
    ...
    function ajustarIframe(iframe) {
        ...
        aplicarEstilo(iframe, 'width', `${dimensoes.largura}px`);
        aplicarEstilo(iframe, 'max-width', '100%');
        ...
        const atualizarAltura = () => {
            ...
            const mobile = Math.min(window.innerWidth, larguraDisponivel) <= LIMITE_MOBILE;
